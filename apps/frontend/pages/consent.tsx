...
function handleConsent(ws: WebSocket, consent: boolean) {
  return () => {
    ws.send(
      Buffer.from(
        JSON.stringify({
    ...
    <RootLayout>
      <div className="bg-gray-100 h-screen flex  justify-center items-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-96">
          ...
          <p className="mb-4">
            {customerName} will be matching your profile to their products
            catalog using the following data from Google Takeout:
          </p>
